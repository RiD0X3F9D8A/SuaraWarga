...
<head>
    ...
    <title>Login - Sistem RT Digital</title>
...
<body class="login-page position-relative">
    ...
    <div class="login-card-wrapper p-4">
        <div class="text-center mb-4">
            <div class="brand-logo-login">
                <i class="bi bi-house-heart-fill"></i>
            </div>
            <h2 class="fw-bold text-primary-custom" style="font-family: var(--font-heading);">Sistem Warga Digital</h2>
            <p class="text-muted">Masuk untuk mengelola aspirasi & voting RT</p>
        </div>
        ...
        <div class="card shadow-lg border-0 overflow-hidden">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" class="form-control border-start-0 ps-0 bg-light" 
                                   placeholder="nama@email.com" required style="height: 50px;">
                        </div>
                    </div>
                    
                    <div class="mb-5">
                        <label for="password" class="form-label text-muted small text-uppercase fw-bold ls-1">Kata Sandi</label>
                        <div class="input-group">
            ...
            <div class="card-footer bg-light text-center py-3 border-top-0">
                <small class="text-muted">Belum punya akun? <a href="/register" class="fw-bold text-primary-custom">Daftar Warga</a></small>
            </div>
        </div>
        
        <div class="text-center mt-4">
             <small class="text-muted opacity-75">&copy; 2025 Sistem RT Digital. Aman & Terpercaya.</small>
        </div>
    </div>
